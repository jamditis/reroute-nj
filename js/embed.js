...
(function () {
  ...
  function downloadHtml() {
    ...
    var html = '<!DOCTYPE html>\n' +
      ...
      '    body { font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; background: #fafaf7; color: #142b38; line-height: 1.6; padding: 12px; }\n' +
      '    body.theme-dark { background: #142b38; color: #f0f4f1; }\n' +
      '    .card { background: #fff; border: 1px solid #d3dcd9; border-radius: 6px; overflow: hidden; max-width: 480px; margin: 0 auto; }\n' +
      '    .theme-dark .card { background: #152c4b; border-color: #52636b; }\n' +
      ...
      '    .card-line-context { font-size: .8rem; color: #52636b; margin-bottom: 8px; }\n' +
      ...
      '    .card-summary { font-size: .85rem; color: #465b64; margin-bottom: 12px; line-height: 1.7; }\n' +
      '    .card-stats { display: flex; gap: 16px; margin-bottom: 12px; border-block: 1px solid #e4e9e5; padding-block: 14px; }\n' +
      ...
      '    .card-stat-label { font-size: .7rem; color: #52636b; }\n' +
      '    .card-alternatives { margin-bottom: 12px; }\n' +
      '    .card-alternatives h4 { font-size: .8rem; font-weight: 600; margin-bottom: 6px; color: #465b64; }\n' +
      '    .card-alt-item { font-size: .8rem; padding: 8px 0; border-bottom: 1px solid #e4e9e5; }\n' +
      '    .card-alt-item:last-child { border-bottom: none; }\n' +
      '    .card-dates { font-size: .75rem; color: #52636b; margin-bottom: 12px; }\n' +
      '    .card-cta { min-height: 44px; display: inline-flex; align-items: center; padding: 10px 16px; background: #175c50; color: #fff; text-decoration: none; border-radius: 4px; font-size: .8rem; font-weight: 600; }\n' +
      '    .card-cta:hover { background: #142b38; }\n' +
      '    .card-cta:focus-visible, .card-attribution a:focus-visible { outline: 3px solid #175c50; outline-offset: 3px; }\n' +
      '    .card-attribution { text-align: center; padding: 8px 0; font-size: .7rem; color: #52636b; }\n' +
      '    .card-attribution a { color: #175c50; display: inline-flex; align-items: center; min-height: 44px; text-decoration: underline; text-underline-offset: 3px; }\n' +
      '    .card-attribution a::before { content: ""; display: inline-block; width: 26px; height: 24px; margin-inline-end: 6px; background: url("data:image/svg+xml;base64,") center / contain no-repeat; }\n' +
      '    .summary-grid { display: grid; gap: 8px; }\n' +
      '    .summary-line { display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: #f0f4f1; border-radius: 4px; }\n' +
      ...
      '    .summary-trains { font-size: .75rem; color: #52636b; white-space: nowrap; }\n' +
      '    .theme-dark .summary-line { background: #142b38; }\n' +
      ...
      '    .theme-dark .card-stats, .theme-dark .card-alt-item { border-color: #52636b; }\n' +
      '    .theme-dark .card-attribution, .theme-dark .card-attribution a { color: #d7e6ff; }\n' +
      '    .theme-dark .card-attribution a::before { background-image: url("data:image/svg+xml;base64,"); }\n' +
      '    .theme-dark .card-cta { background: #d7e6ff; color: #142b38; }\n' +
